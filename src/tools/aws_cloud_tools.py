...
def get_member_discovery_setup_steps(
    ...
    create_stackset_cmd = (
        ...
        f"  --template-url \"{template_url}\" \\\n"
        f"  --parameters "
        f"ParameterKey=HostedInfrastructureRoleArn,ParameterValue=\"{infra_role_arn}\" "
        f"ParameterKey=HostedInfrastructureUserArn,ParameterValue=\"{infra_user_arn}\" \\\n"
        f"  --capabilities CAPABILITY_NAMED_IAM \\\n"
    ...
    browser_steps = (
        ...
        f"   - HostedInfrastructureRoleArn: {infra_role_arn}\n"
        f"   - HostedInfrastructureUserArn: {infra_user_arn}\n"
